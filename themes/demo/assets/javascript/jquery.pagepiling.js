    ...
    $.fn.pagepiling = function (custom) {
        ...
        */
        ...
        $('.pp-section').each(function (index) {
            ...
            if(options.verticalCentered && !$(this).hasClass('scrollable')){
                addTableClass($(this));
            }
        ...
        */
        function scrollPage(destination, animated) {
            ...
            v.destination.addClass('is-inview').siblings().removeClass('is-inview');
            
            v.destination.find('.has-animation').addClass('is-inview');
            v.destination.siblings().find('.has-animation').removeClass('is-inview');
            
            v.destination.siblings().find('.part-small-wrapper').removeClass('active');
            
            if (v.destination.hasClass('background-dark')) {
                $("body").addClass("white-menu");
            } else {
                $("body").removeClass("white-menu");    
            }
            
            if (v.destination.hasClass('scrollable')) {
                $("section.active").scrollTop(0);
                $("html").addClass('has-scroll-enabled');
            } else {
                $("section.active").scrollTop(0);
                $("html").removeClass('has-scroll-enabled');
            }
        ...
        */
        function isScrollable(activeSection){
            return activeSection.filter('.scrollable');
        }
